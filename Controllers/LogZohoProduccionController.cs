...
namespace RestAPIDemo.Controllers
{
    ...
    [Route("[controller]")]
    [ApiController]
    public class LogZohoProduccionController : Controller
    {
        ...
        public LogZohoProduccionController(IConfiguration iConfiguration)
        {
        ...
        public async Task<ActionResult<IEnumerable<SabanaLog>>> GetTodoItems()
        {
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(builder.ConnectionString))
                {
                    ...
                    String query = "Select top 5 * From LogProduccion Order By IdEvento Desc";
                    //Ejecutamos la query
